  ...
  <div class="space-y-5">
    ...
    <div class="bg-white rounded-xl border border-gray-200 px-4 py-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
        <button @click="refreshInvoices" class="w-full px-4 py-2 text-xs font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors sm:w-auto">Refresh</button>
        <button class="w-full px-4 py-2 text-xs font-medium text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors sm:w-auto">Export Invoices</button>
        <button class="w-full px-4 py-2 text-xs font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors sm:w-auto">Create POS Invoice</button>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 px-4 py-5 sm:px-6">
      ...
      <div class="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-end">
        ...
        <button @click="resetFilters" class="w-full px-5 py-2.5 text-xs font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors sm:w-auto">Reset</button>
        <button @click="applyFilters" class="w-full px-5 py-2.5 text-xs font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors sm:w-auto">Apply Filter</button>
      </div>
    </div>
