      ...
      <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 px-6 py-5">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
            ...
            <div>
              <label class="text-xs text-gray-500 mb-1 block">Hall Type <span class="text-red-500">*</span></label>
              <select v-model="form.hall_type"
                class="w-full text-xs border border-gray-200 rounded-lg px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
...
const allItems    = ref([])  // Hall item group only — for Hall Item field
const amenityItems = ref([]) // All items — for Amenities table
...
onMounted(async () => {
  try {
    ...
    if (existing) {
      ...
      form.value.hall_type     = existing.hall_type     || 'Conference'
