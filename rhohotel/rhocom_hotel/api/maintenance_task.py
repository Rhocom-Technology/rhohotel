...
#     # Resolve requesting_department name
#     requesting_dept_name = None
#     if task.requesting_department:
#         requesting_dept_name = frappe.db.get_value(
#             "Department", task.requesting_department, "department_name"
#         ) or task.requesting_department

#     # Resolve witness_department name
#     witness_dept_name = None
#     if task.witness_department:
#         witness_dept_name = frappe.db.get_value(
#             "Department", task.witness_department, "department_name"
#         ) or task.witness_department
...
#         "requesting_department": task.requesting_department,
#         "requesting_department_name": requesting_dept_name,
#         "witness_department": task.witness_department,
